...
void EmptyLinkFunctionForGeneratedCodeProjetUnreal_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_ProjetUnreal()
	{
		if (!Z_Registration_Info_UPackage__Script_ProjetUnreal.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_ProjetUnreal_OnSlotHovered__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_ProjetUnreal_OnSlotUnhovered__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_ProjetUnreal(Z_Construct_UPackage__Script_ProjetUnreal, TEXT("/Script/ProjetUnreal"), Z_Registration_Info_UPackage__Script_ProjetUnreal, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x9567B071, 0xFDB2E68C));
